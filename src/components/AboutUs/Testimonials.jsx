...
function SampleNextArrow(props) {
  ...
  return (
    <div className={`${className} awards__arrow-right`} onClick={onClick}>
      <img
...
function SamplePrevArrow(props) {
  const { className, onClick } = props;
  return (
    <div className={`${className} awards__arrow-left`} onClick={onClick}>
      <img
        src={svgs.right_arrow}
        alt=""
        className="size-6"
...
const Testimonials = () => {
  ...
  return (
    <section className="our-awards" id="testimonials">
